...
export default function JobOrderCreate({
    companies,
    users,
}: {
    companies: Company[];
    ...
    const selectedUser = users.find(
        (u) => u.id.toString() === data.assigned_to_id
    );
        ...
        <Authenticated>
            <div className="max-w-4xl mx-auto py-8 px-4">
                <div className="flex items-center justify-between mb-6">
                    <h1 className="text-2xl font-bold">New Job Order</h1>
                ...
                <form onSubmit={submit} className="space-y-6">
                        ...
                        <CardContent className="pt-5 grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    value={companyQuery || selectedCompany?.name || ""}
                    ...
                    {/* Inspector / Assignment Information */}
                    <Card>
                        <div className="bg-blue-600 text-white px-4 py-2 rounded-t-md font-semibold text-sm">
                        ...
                        <CardContent className="pt-5 grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    value={userQuery || selectedUser?.name || ""}
